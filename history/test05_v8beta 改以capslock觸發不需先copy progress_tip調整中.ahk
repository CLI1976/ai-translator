...
class ProgressTip {
    ...
    static Show(text := "正在處理中...") {
        try {
            ...
            ; 創建半透明提示視窗
            progressGui := Gui("+AlwaysOnTop +ToolWindow")  ; 移除 -Caption 先測試
            progressGui.BackColor := "0x2C3E50"  ; 深藍色背景
            progressGui.SetFont("s10 c0xFFFFFF", "微軟正黑體")  ; 白色文字
            ...
            ; 設置透明度
            WinSetTransparent(180, progressGui)
...
GuiResize(thisGui, MinMax, Width, Height) {
    ...
    ; 計算各區域高度
    originalHeight := Floor(availableHeight * 0.4)
    translatedHeight := Floor(availableHeight * 0.6) - 60
